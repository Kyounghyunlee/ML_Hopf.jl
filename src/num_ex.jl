...
a = @pgf Axis(
    ...
    Plot({color = "red", no_marks}, Coordinates(tv, predict_time_T(p)[2 * (1 - 1) + 1, :])),
    LegendEntry("Learnt model"),
    Plot({color = "blue", no_marks}, Coordinates(tv, A3[2 * (1 - 1) + 1, :])),
    LegendEntry("Ground truth"),
)
...
a = @pgf Axis(
    ...
    Plot(
        {color = "red", no_marks}, Coordinates(tv, predict_time_T(p)[2 * (10 - 1) + 1, :])
    ),
    LegendEntry("Learnt model"),
    Plot({color = "blue", no_marks}, Coordinates(tv, A3[2 * (10 - 1) + 1, :])),
    LegendEntry("Ground truth"),
)
